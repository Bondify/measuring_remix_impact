...
annotations=[
        dict(x=1, y=0.48, xref="paper", yref="paper", text="Agency to Community centric", showarrow=False, 
             font=dict(family=annotation_family,
                       size=axis_size,
                       color='rgb(135,135,135)')
        ),
        dict(x=.46, y=0.9,xref="paper",yref="paper",text="Impact",showarrow=False,
             font=dict(family=annotation_family,
                       size=axis_size,
                       color='rgb(135,135,135)') 
        ),
...
layout = go.Layout(annotations = annotations, shapes = shapes,
    showlegend=False, hovermode='closest', template='simple_white', height=700,
    ...
    [
       ...
       html.Div([
           html.Div(
            ...
            style={"width": "75%",'float': 'left',#'padding': '0 20'
                   }
            ),
